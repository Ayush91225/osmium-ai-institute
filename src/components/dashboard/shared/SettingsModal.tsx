            ...
            <div className="p-6 pb-8 space-y-6">
                          ...
                          <div className="text-xs">
                            <div className="mb-2">
                              ...
                              <p className={`font-semibold mt-1 ${
                                isDarkMode ? 'text-zinc-100' : 'text-gray-900'
                              }`}>Tech Hub, Innovation District<br />Bangalore, Karnataka 560001</p>
                            </div>
                            <div className="flex items-center gap-2">
                              <span className={`font-medium ${
                                isDarkMode ? 'text-zinc-500' : 'text-gray-500'
                              }`}>Maps:</span>
                              <a href="https://maps.google.com/osmium-institute" target="_blank" rel="noopener noreferrer" className="text-[#8C7B65] font-semibold hover:underline flex items-center gap-1 transition-all duration-200 hover:text-[#A0906F]">
                                View Location
                                <i className="ph ph-arrow-square-out" style={{ fontSize: '10px' }} />
                              </a>
                            </div>
                          </div>
                        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <button 
                    onClick={() => window.open(`/forgot?email=${encodeURIComponent('contact@osmium.co.in')}`, '_blank')}
