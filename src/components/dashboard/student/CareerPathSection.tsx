    ...
    <div className={`rounded-xl p-6 border h-full flex flex-col ${isDarkMode ? 'bg-zinc-900/50 border-zinc-800/50' : 'bg-white border-gray-200'}`}>
      ...
      <div className="space-y-3 mt-6 flex-1">
        {careers.map((career, index) => (
          <div key={index} className={`p-4 rounded-lg border flex items-center justify-between ${isDarkMode ? 'bg-zinc-800/30 border-zinc-700/50' : 'bg-gray-50 border-gray-200'}`}>
            <div className="flex items-center gap-3 flex-1">
              <div className={`w-10 h-10 rounded flex items-center justify-center flex-shrink-0 ${isDarkMode ? 'bg-zinc-700' : 'bg-white'}`}>
                {career.icon === 'code' && (
                  <svg width="20" height="20" viewBox="0 0 256 256" fill="currentColor" className={isDarkMode ? 'text-blue-400' : 'text-blue-600'}>
                    <path d="M69.12,94.15,28.5,128l40.62,33.85a8,8,0,1,1-10.24,12.29l-48-40a8,8,0,0,1,0-12.29l48-40a8,8,0,0,1,10.24,12.3Zm176,27.7-48-40a8,8,0,1,0-10.24,12.3L227.5,128l-40.62,33.85a8,8,0,1,0,10.24,12.29l48-40a8,8,0,0,0,0-12.29ZM162.73,32.48a8,8,0,0,0-10.25,4.79l-64,176a8,8,0,0,0,4.79,10.26A8.14,8.14,0,0,0,96,224a8,8,0,0,0,7.52-5.27l64-176A8,8,0,0,0,162.73,32.48Z"/>
                  </svg>
                )}
                {career.icon === 'android' && (
                  <svg width="20" height="20" viewBox="0 0 256 256" fill="currentColor" className={isDarkMode ? 'text-green-400' : 'text-green-600'}>
                ...
                {career.icon === 'database' && (
                  <svg width="20" height="20" viewBox="0 0 256 256" fill="currentColor" className={isDarkMode ? 'text-red-400' : 'text-red-600'}>
            ...
            <svg width="20" height="20" viewBox="0 0 256 256" fill="currentColor" className={`flex-shrink-0 ${isDarkMode ? 'text-zinc-500' : 'text-gray-400'}`}>
