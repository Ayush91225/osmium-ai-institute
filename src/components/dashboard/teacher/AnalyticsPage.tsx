...
export default function AnalyticsPage() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif" }} className="p-8 min-h-screen max-md:p-3">
      <div className="flex justify-between items-center mb-8 max-md:flex-col max-md:items-start max-md:gap-3">
        <h1 className="text-2xl font-bold text-[#1A1A1A]">Class 12-0B</h1>
        <button 
          onClick={() => setExportModalOpen(true)}
          className="flex items-center gap-2 px-4 py-2 border border-[#E5E5E5] rounded-lg bg-white text-sm font-medium cursor-pointer hover:bg-[#F5F5F5] transition-all duration-200"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-5 rounded-xl border border-[#E5E5E5]">
          ...
          <div className="flex items-baseline gap-3">
            ...
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#ECFDF5] text-[#047857]">36 Active Students</span>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-xl border border-[#E5E5E5]">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-2 text-[#74797e]">
              ...
              <span className="text-sm font-medium">Scheduled Upcoming Tests</span>
            </div>
          </div>
          <div className="flex items-baseline gap-3">
            <span className="text-3xl font-semibold text-[#111827]">5</span>
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#ECFDF5] text-[#047857]">+2 This Week</span>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-xl border border-[#E5E5E5]">
          ...
          <div className="flex items-baseline gap-3">
            ...
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#FEE2E2] text-[#B91C1C]">View Review</span>
          </div>
        </div>
      </div>
